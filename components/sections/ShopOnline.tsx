...
<BaseButton text="Download the App" variant="black" />
   ...
   <div className='hidden md:flex flex-col justify-end h-full  relative items-center'>
     <Image src={ImageAssets.ShoppingImage1} alt={'Shopping Image 1'} className='absolute top-0 left-0' />
     <Image src={ImageAssets.ShoppingImage2} alt={'Shopping Image 1'} className='absolute top-0 right-0' />
     <Image src={ImageAssets.ShoppingImage2} alt={'Shopping Image 1'} className='absolute bottom-1/4 -left-1/12' />
     <Image src={ImageAssets.ShoppingImage3} alt={'Shopping Image 1'} className='absolute bottom-0 left-0'/>
     <Image src={ImageAssets.ShoppingImage1} alt={'Shopping Image 1'} className='absolute bottom-0 right-0'/>
     <Image src={ImageAssets.ShoppingImage4} alt={'Shopping Image 1'} className='absolute bottom-0 right-1/2'/>
     <Image src={ImageAssets.ShoppingImage4} alt={'Shopping Image 1'} className='absolute bottom-1/2 right-0'/>
     <Image src={ImageAssets.ShoppingImage1} alt={'Shopping Image 1'} className='absolute top-1/3 right-1/2'/>
