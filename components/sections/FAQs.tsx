...
const FAQs = () => {
  ...
  return (
    <section className='bg-purple-500 min-h-screen w-full grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-0 py-8 lg:py-12 px-4 lg:px-0'>
      
      <div className='lg:col-span-1 text-white flex flex-col justify-center gap-6 lg:gap-8 max-w-full lg:max-w-[340px] p-4 lg:p-8'>
        <h2 className='text-3xl lg:text-2xl font-black text-center lg:text-left'>FAQs</h2>
