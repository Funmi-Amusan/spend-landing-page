...
const Gallery = () => {
  ...
  const [currencyBackgroundPhase, setCurrencyBackgroundPhase] = useState('down');
  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div
          className='hidden md:flex absolute top-1/5 left-1/12 bg-purple-500 rounded-4xl w-32 aspect-square items-center justify-center overflow-hidden'
        >
            <motion.div
              key={`bg-${currencyAnimationKey}`}
              variants={currencyBackgroundPhase === 'up' ? backgroundSlideVariants : backgroundSlideDownVariants}
              initial="initial"
              animate="animate"
        ...
        <motion.div
          className="hidden md:flex absolute top-1/3 right-2/12 bg-blue-600 rounded-4xl w-32 aspect-square items-center justify-center overflow-hidden"
        >
